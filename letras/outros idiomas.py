...
<body>
    <header>
        ...
        <div class="container">
            <div class="letra">
<div id="conteudo"data-novo-conteudo="<h1>{h1_trad}</h1><h2>{h2_text}</h2>
{p_trad}"><h1>{h1_text}</h1><h2>{h2_text}</h2>
{p_text}</div>
                <h4>Compositor: {h4_text}</h4>
            </div>
            <div class="but">
                <button class="idioma" onclick="alterarConteudo()"><span class="flag-icon flag-icon-br"></span>Tradução</button>
                <button class="idioma" onclick="recuperarConteudo()"><span class="flag-icon flag-icon-us"></span>Letra Original</button> 
            </div>
            <div class="video">
...
h1t_label = Label(window, text="Nome da música em português(h1):")
h1t_label.pack()
h1t_entry = Entry(window)
h1t_entry.pack()

pt_label = Label(window, text="Letra da música em português(p):")
pt_label.pack()
pt_entry = Entry(window)
pt_entry.pack()
